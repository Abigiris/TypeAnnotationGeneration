...
def mask_credentials(text, field_names):
...
class Api(VBox):
    ...
    def __init__(self,
                 ...
                 timeout = 10,
                 cassette_path = '',
                 views = builtin_view_classes,
                 additional_views = [],
                 post_process_resp = None,
                 config=None):  # FIXME: use config
        """

...
class Source(ABC):
    ...
    @abstractmethod
    def retrieve(self, run_cmd, work_dir = ''):
...
class GitSource(Source):
    ...
    def __init__(self, url, ref, pull_submodules = False):
        self.url = url
        self.ref = ref
...
class DockerContainer:
    ...
    def __init__(self, image = '', bootstrap_cmds = []):
    ...
    def program_available(self, program):
        try:
    ...
    def run_cmd(self, cmd, cwd = None, return_output=False):
    ...
    def import_file(self, src_path, dest_path):
    ...
    def export_file(self, src_path, dest_dir):
...
class DebInfo:
    ...
    def prepare(self, builder, work_dir):
    ...
    def _get_checkinstall_requires_opt(self):
        parts = []
...
class LzDeb:
    ...
    @staticmethod
    def from_config_dir(config_dir):
    ...
    def inject_file(self, container, file_path):
